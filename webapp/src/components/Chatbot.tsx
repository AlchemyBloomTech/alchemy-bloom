...
import { Sparkles, MessageCircle } from 'lucide-react'; // Optional icons
import angelWings from '../assets/angel-wings.png'; // You can add a soft angel wing image if desired
...
const Chatbot: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const errorReply: Message = { sender: 'angel', text: 'Something went wrong. Try again later.' };
